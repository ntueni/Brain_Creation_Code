...
This creates a .csv file given the statistical information for each region with in the files listed in 'fileNames'
"""
...
path = "./Example_files/"
fileNames = ["OAS1_0002_MR1_atrophy_1R", "OAS1_0002_MR1_atrophy_9R"]
out_path = path
filenameOUT = "Atrophy_data_1R_vs_9R.csv"
    ...
    if (exists(fullFilename1)):
        ...
        for idx in range(0,numArray):
            ...
            if "material" not in arr_full_name:
                # if (arr_full_name == 'max_principal_strain'):
                    # Read in strain data for file 1 and rename array
...
for fileName,arrays in dataMap.items():
    ...
    for arrayName,data_per_region in regional_data.items():
        quantity = arrayName
