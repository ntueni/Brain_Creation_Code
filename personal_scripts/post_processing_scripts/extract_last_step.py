...
# Set the paths
base_directory = "path_to_tumor/atrophy_outputs"
output_path =  "path_to_post_processing_output"

for folder_name in os.listdir(base_directory):
    folder_path = os.path.join(base_directory, folder_name)
    
    # Change folder name in line below 
    if os.path.isdir(folder_path) and "OAS1_0002_MR1_atrophy" in folder_name:
